...
The mission of the data-privacy-stack organization is to steward the Presidio open source project by providing governance, coordination, and decision-making structures that support its continued development, adoption, and sustainability as a privacy-focused technical foundation.

The data-privacy-stack organization exists to:
...
The data-privacy-stack organization is responsible for the governance of the Presidio project.
...
The data-privacy-stack organization shall operate under a Technical Steering Committee (TSC) responsible for governance decisions affecting the Presidio project.
...
Decisions within the data-privacy-stack organization shall be made using a consensus-based approach.
